...
import cn.itcast.core.util.UserServiceForData;
...
public class DataController {
    ...
    @Autowired
    private UserServiceForData userServiceForData;

    @RequestMapping("getData")
    public void exportExcelData(HttpServletRequest request, HttpServletResponse response){
        //获取后台数据
        List<User> userList = userServiceForData.findAlluser();
        // 定义表的标题
        String title = "User数据";
        //定义表的列名
    ...
    public void get(HttpServletRequest request, HttpServletResponse response){
        //获取后台数据
        List<ContentCategory> cate = userServiceForData.findCate();
        // 定义表的标题
        String title = "Cate数据";
        //定义表的列名
    ...
    public void getGoods(HttpServletRequest request, HttpServletResponse response){
        //获取后台数据
        List<Goods> goods = userServiceForData.findGoods();
        // 定义表的标题
